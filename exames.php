...
?>
 ...
 <head>
  ...
  <title>Exames - DoctorSystem </title>
 </head>
 <body>
			...
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="bi bi-person-dash-fill"></i> <span>Deletar Paciente</span></a>						
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<tbody>
					<tr>
						...
						<td>(171) 555-2222</td>
						<td>
							<a href="#editEmployeeModal" class="editar" data-toggle="modal"><i class="bi bi-pen-fill"></i></a>
							<a href="#deleteEmployeeModal" class="deletar" data-toggle="modal"><i class="bi bi-x-circle-fill"></i></a>
						</td>
					</tr>
				</tbody>
			</table>
